...
int retorno(int *linhafinal, int *colunafinal)
{
  ...
  //Alterei linha e coluna porque só consigo visualizar assim mas só trocar o nome depois
  ...
  if (entrada == 1)
  {
    ...
    //Se entrada igual a 1 eu adiciono uma linha para a 2 entrada de dados
  }
